package com.sistemaSalud.response;
...
public class ResponseHandler {
	...
	private static Map<String, Object> resultGenerateResponseSuccess(String message, HttpStatus status,Object responseObj){
	...
	private static Map<String, Object> resultGenerateResponseError(String message, HttpStatus status){
